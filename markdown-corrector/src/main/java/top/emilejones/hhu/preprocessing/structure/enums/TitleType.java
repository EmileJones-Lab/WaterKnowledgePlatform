...
public enum TitleType {
    ...
    TYPE_HIERARCHICAL_4("^(?:#+\\s*)?([0-9]{1,2}\\.[0-9]{1,2}\\.[0-9]{1,2}\\.[0-9]{1,2}\\.?)\\s+(.+)$",
            "^(?:#+\\s*)?[0-9]+\\.[0-9]{1,2}\\.[0-9]{1,2}\\.1(?:\\s+|$)(.+)",
            "四级标题 1.1.1.1"),
    TYPE_HIERARCHICAL_3("^(?:#+\\s*)?([0-9]{1,2}\\.[0-9]{1,2}\\.[0-9]{1,2}\\.?)\\s+(.+)$",
            "^(?:#+\\s*)?[0-9]+\\.[0-9]{1,2}\\.1(?:\\s+|$)(.+)$",
            "三级标题 '1.1.1' 和 '1.1.1.'"),
    TYPE_HIERARCHICAL_2("^(?:#+\\s*)?([0-9]{1,2}\\.[0-9]{1,2}\\.?)\\s+(.+)$",
            "^(?:#+\\s*)?[0-9]+\\.1(?:\\s+|$)(.+)$",
            "二级标题 1.1"),
    ...
    TYPE_CHINESE_PARENTHESIZED_NUMBER("^(?:#+\\s*)?（([一二三四五六七八九十]+)）\\s*(.+)$",
            "^(?:#+\\s*)?（一）\\s*(.+)$",
            "括号中文数字 （一）"),
    TYPE_ARABIC_NUMBER("^(?:#+\\s*)?([0-9]{1,2})(?!\\d|\\.[0-9])(?:[\\.．。、]\\s*|\\s+)(.+)$",
