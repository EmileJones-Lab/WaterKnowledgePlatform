...
public class PipelineStateMachineConfig extends EnumStateMachineConfigurerAdapter<PipelineState, PipelineEvent> {
    ...
    public PipelineStateMachineConfig(OcrAction ocrAction, StructureExtractionAction structureExtractionAction, EmbeddingAction embeddingAction, CompletionAction completionAction, FailureAction failureAction) {
    ...
    public void configure(StateMachineTransitionConfigurer<PipelineState, PipelineEvent> transitions) throws Exception {
        transitions
                // OCR -> STRUCTURE_EXTRACTION -> EMBEDDING
                .withExternal()
                ...
                .and()
                .withExternal()
                .source(PipelineState.STRUCTURE_EXTRACTION).target(PipelineState.EMBEDDING).event(PipelineEvent.TO_EMBEDDING)
                .and()
                .withExternal()
