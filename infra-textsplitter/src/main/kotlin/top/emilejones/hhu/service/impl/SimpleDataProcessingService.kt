 ...
 * @author EmileJones
 */
class SimpleDataProcessingService(
...
) : ISimpleDataProcessingService {
    private val logger = LoggerFactory.getLogger(SimpleDataProcessingService::class.java)
    private val scope = CoroutineScope(Dispatchers.IO + SupervisorJob())
    private val collectionName: String = "Single"
